...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            // In a real app, we might need email verification, but for MVP we assume redirect
            router.push("/login");
        }
    };
        ...
        <div className="flex items-center justify-center min-h-screen p-4">
            ...
            >
                <div className="text-center space-y-2">
                    <h1 className="text-3xl font-bold tracking-tight text-gradient font-outfit">Join CSIS</h1>
                    <p className="text-slate-400">Master your academic destiny. Start tracking today.</p>
                </div>
